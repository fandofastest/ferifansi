...
export default function SubCategoryModal({ isOpen, onClose, onSubmit, categories }: SubCategoryModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="w-[400px] p-6 bg-white dark:bg-gray-800 rounded-lg">
        <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Create New Sub Category</h2>
